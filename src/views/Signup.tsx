...
const Signup = () => {
	...
	const onSubmit = (data: SignupCred) => {
		...
		axios
			...
			.catch((err) => {
				setSignupStatus('There was an error while adding new user')
			})
	}
				...
				<div className='form-wrapper'>
					...
					<form onSubmit={handleSubmit(onSubmit)} noValidate>
						...
						<div className='element'>
							...
							{errors.passwordMatch && errors.passwordMatch.type === 'oneOf' && (
								<ErrorMessage message='Passwords must match!' />
							)}
						</div>
						{signupStatus && <ErrorMessage message={signupStatus} />}
